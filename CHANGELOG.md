...
- #1481: Fix checkFeeStatusAsync duplicate asset resolution issues with PLC
...
- #359: Added green pulsing buy button when PLC is under 1 PLC
...
Bug fixes
--------
- #658 PLC trade button missing from portfolio view
...
- Issue #364 - Present an error message that disallows the use of Incognito with the PLC wallet (#394)
...
Bug fixes
--------
- Fix #188: Total calculation (PLC) is not displayed correctly
...
- Fix a rounding issue when estimating non-PLC fees in the exchange
...
- A bug when importing old PLC 1 balances has been fixed
...
Bug fixes
--------
- Add PlayChain bloom filter for PLC 1 account imports
...
New features
--------
- Allow fees for order cancellation and shorting to be paid in assets other than PLC
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the PlayChain blockchain
...
- Allow account upgrade, voting, permission changes and withdrawals to be paid in assets other than PLC if necessary #786
...
- Add base groups to MyMarkets: PLC, BTC, USD or CNY + others
...
- Remove link to PLC:PLC market in asset popover, fix asset description #709
...
NEW FEATURES:
- Option to pay fees in PLC if possible #356
...
- Show PLC balance in Accounts search results table #482
...
- Transfer Dialog does not fall back to PLC fee when there is no core exchange rate or funded fee pool #329
