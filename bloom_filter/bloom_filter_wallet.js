...
// Filter PLC 0.9.2+ import keys export file so that it will include only private keys
// that may be found in the PLC 2.0 genesis block.
// Dependencies:
...
* The bloom filter was created with a genesis containing PLC prefixed keys.  Create
