...
shareholders of PlayChain can cast a vote for your preferred block producers on the blockchain. Those *witnesses* with the most votes are allowed to produce blocks.
...
* A daily total budget of 400k PLC for all workers
* 5 worker proposals with a positive votes total, with daily pay requests of 100k PLC each

Now the four workers with the most votes will all receive 100k PLC each per day, but once they've been paid the worker budget is empty. Therefore the fifth worker will receive nothing.
