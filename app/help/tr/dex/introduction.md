...
Merkezsiz borsa (kısaca *DEX*) , PlayChain ekosisteminde 
...
Bunlardan kısaca bahsetmek istiyoruz. PlayChain DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. PlayChain'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  PlayChain evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  PlayChain DEX varlığın muhteviyatını bilmez , dolayısı ile **her türlü**  eşleşme ticareti 
...
* **Limit Yok** :
  PlayChain protokolünün sizin ticaret deneyiminizi sınırlaması mümkün değildir.
* **Merkezsiz** :
  DEX (merkezsiz borsa) tüm dünyaya dağıtıktır. Bölece tek kırılma noktası 
  olmadığı gibi bu PlayChain borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine PlayChain DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  PlayChain DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  PlayChain'in en büyük özelliklerinden biri de bitUSD, bitEUR, bitCNY gibi 
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USD,EUR,CNY 
  ...
  fiyatında hesap görümü için mevcut olabilen, **PlayChain'in şirket hisseleri (PLC)** 
   vardır.