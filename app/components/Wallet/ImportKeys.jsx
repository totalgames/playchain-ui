...
class ImportKeys extends Component {
    ...
    /** PLC 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // PLC 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    PLC 1.0 hosted wallet backup (wallet.bitshares.org) is supported.

    PLC 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function(pubkey, account_name) {
            ...
            address = "PLC" + address.substring(3);
        ...
        try {
            ...
            if (!encrypted_brainkey)
                throw "Please use a PLC 1.0 wallet_export_keys file instead";
